...
#import "DessertWinesViewController.h"

@interface DessertWinesViewController ()

@end

@implementation DessertWinesViewController
...
- (void)viewDidLoad
{
	...
	NSString *path = [[NSBundle mainBundle] pathForResource:@"DessertWines" ofType:@"plist"];
...
{
	if ([segue.identifier isEqualToString:@"showDessertWineDetail"]) {
