...
#import "WhiteWinesViewController.h"

@interface WhiteWinesViewController ()

@end

@implementation WhiteWinesViewController
...
- (void)viewDidLoad
{
	...
	NSString *path = [[NSBundle mainBundle] pathForResource:@"WhiteWines" ofType:@"plist"];
...
{
	if ([segue.identifier isEqualToString:@"showWhiteWineDetail"]) {
