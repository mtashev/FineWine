...
#import "RoseWinesViewController.h"

@interface RoseWinesViewController ()

@end

@implementation RoseWinesViewController
...
- (void)viewDidLoad
{
	...
	NSString *path = [[NSBundle mainBundle] pathForResource:@"RoseWines" ofType:@"plist"];
...
{
	if ([segue.identifier isEqualToString:@"showRoseWineDetail"]) {
